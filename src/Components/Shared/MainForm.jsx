...
const MainForm = ({
  ...
  const onSubmit = async (data) => {
    ...
    posterFormData.append("image", fileData.profile_picture);


    console.log(fileData.profile_picture, "fileData")


    const posterResponse = await axios.post(imageHostingUrl, posterFormData);
    const profile_picture = posterResponse.data.data.url;
    console.log(profile_picture, "posterResponse")



    const formDataWithFiles = { ...data, profile_picture };
